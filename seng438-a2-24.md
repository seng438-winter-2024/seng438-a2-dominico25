...
| 11 | testCalcRowNullObject() | calculateRowTotal() | (row, col, data) Values2D data = null, int row = 1 | This test should envoke the InvalidParameterException since a null object is passed in instead of a normal Values2D object. | Testing calculateRowTotal() with an invalid input (null object). |
